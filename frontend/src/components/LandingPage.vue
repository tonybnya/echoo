<template>
  <div class="min-h-screen bg-[#030712] text-white selection:bg-blue-500/30">
    <nav class="flex items-center justify-between px-6 py-4 max-w-7xl mx-auto border-b border-gray-800/50">
      ...
      <div class="flex items-center gap-4">
        <router-link to="/auth" class="text-sm font-medium hover:text-blue-400 transition-colors">
          Sign In
        </router-link>
        <router-link to="/auth" class="px-5 py-2 bg-blue-600 hover:bg-blue-700 text-sm font-bold rounded-full transition-all shadow-lg shadow-blue-500/20">
          Get Started
        </router-link>
      </div>
    </nav>
      ...
      <section class="max-w-7xl mx-auto px-6 pt-24 pb-32 text-center relative z-10">
        ...
        <div class="flex flex-col sm:flex-row items-center justify-center gap-4">
          ...
          <a 
            ...
            target="_blank" 
            class="w-full sm:w-auto px-8 py-4 bg-[#0b101f] border border-gray-800 text-white font-bold rounded-xl hover:bg-[#161d2f] transition-all text-center"
          >
            View on GitHub
          </a>
        </div>
    ...
    <footer class="border-t border-gray-900 bg-[#020610] py-8">
      <div class="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-6">
        <div class="flex items-center gap-2">
          <img src="@/assets/logo.png" alt="Echoo Logo" class="h-6 w-6 opacity-50" />
          <p class="text-gray-500 text-sm">
            &copy; {{ currentYear }} Echoo Chat. Built with Vue & Django.
          </p>
        </div>
        <div class="flex gap-6">
          <a href="https://linkedin.com/in/tonybnya/" target="_blank" class="text-gray-500 hover:text-white transition-colors" title="LinkedIn">
            <span class="sr-only">LinkedIn</span>
            <i class="fa-brands fa-linkedin text-xl"></i>
          </a>
          <a href="https://github.com/tonybnya/" target="_blank" class="text-gray-500 hover:text-white transition-colors">
            <span class="sr-only">GitHub</span>
            <i class="fab fa-github text-xl"></i>
          </a>
          <a href="https://x.com/tonybnya" target="_blank" class="text-gray-500 hover:text-white transition-colors">
